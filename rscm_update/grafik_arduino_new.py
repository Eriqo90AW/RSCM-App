...
class Graph():
    ...
    def graphUpdate(self, sinyal):
        ...
        self.lines_7    =cache["sensor7"]
        self.lines_8    =cache["sensor8"]
        self.lines_9    =cache["sensor9"]
    ...
    def dic_sensor(self, sinyal):
        ...
        sensor7     =np.append(self.lines_7, sinyal[6])
        sensor8     =np.append(self.lines_8, sinyal[7])
        sensor9     =np.append(self.lines_9, sinyal[8])
